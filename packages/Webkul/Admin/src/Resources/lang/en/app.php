...
return [
    ...
    'sales' => [
        'orders' => [
            ...
            'info' => 'Información',
            'invoices' => 'Facturas',
            'invoices-change-title' => 'Cambiar estado de factura',
            'invoices-change-state-desc' => 'Por favor seleccioná el nuevo estado de la factura:',
            'invoice-status-paid'    => 'Pagado',
            'invoice-status-pending' => 'Pendiente',
            'invoice-status-overdue' => 'Atrasado',
            'invoice-status-update' => 'Guardar cambios',
            'invoice-status-confirmed' => 'El estado de la factura se cambió correctamente.',
            'invoice-status-error' => 'No se pudo actualizar el estado de la factura',
            'shipments' => 'Envíos',
