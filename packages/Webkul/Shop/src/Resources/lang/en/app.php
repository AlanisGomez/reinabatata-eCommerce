...
return [
    ...
    'header' => [
        'title' => 'Cuenta',
        'dropdown-text' => 'Gestioná tus pedidos y lista de deseos',
        'sign-in' => 'Entrar',
        'sign-up' => 'Registrate',
        'account' => 'Cuenta',
        'cart' => 'Bolsa',
    ...
    'checkout' => [
        'cart' => [
            ...
            'create-error' => 'Se encontraron algunos problemas con tu carrito',
            'title' => 'Mi carrito',
            ...
            'quantity' => [
                'quantity' => 'Cantidad',
                'success' => 'Bolsa actualizada exitosamente',
