...
return [
    'admin'         => [
        ...
        'contents'  => [
            'self' => 'Dentro de la misma pestaña',
            'active' => 'Activo',
        ...
        'meta-data' => [
            'footer' => 'Footer',
            'title' => 'Reina Batata información',
    ...
    'customer'      => [
        ...
        'signup-form'       => [
            ...
            'form-sginup-text'  => 'Ya estás muy cerca! Registrate',
        ],
        'forget-password'   => [
            'login'                 => 'Login',
    ...
    'error'         => [
        ...
        'page-lost-description' => "La página que estás buscando no está disponible. Intentá en otro momento.",
    ],
