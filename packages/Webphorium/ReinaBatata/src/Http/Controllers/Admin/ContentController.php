...
namespace Webphorium\ReinaBatata\Http\Controllers\Admin;

use Illuminate\Http\Response;
use Webkul\Product\Repositories\ProductRepository;
use Webphorium\ReinaBatata\Repositories\ContentRepository;
...
class ContentController extends Controller
{
    ...
    */
     ...
     *
     * @var \Webphorium\ReinaBatata\Repositories\ContentRepository
    */
     ...
     * @param  \Webphorium\ReinaBatata\Repositories\ContentRepository  $contentRepository
     * @return void
     */
    ...
    */
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('admin::app.response.create-success', ['name' => trans('reinabatata::app.admin.layouts.header-content')]));
    ...
    public function update($id)
    {
        ...
        session()->flash('success', trans('admin::app.response.update-success', ['name' => trans('reinabatata::app.admin.layouts.header-content')]));
