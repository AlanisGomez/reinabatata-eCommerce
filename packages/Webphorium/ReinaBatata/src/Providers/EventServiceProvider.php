...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        ], 'Webphorium\ReinaBatata\Helpers\AdminHelper@saveLocaleImg');

        Event::listen([
            'catalog.category.create.after',
            'catalog.category.update.after',
        ], 'Webphorium\ReinaBatata\Helpers\AdminHelper@storeCategoryIcon');

        Event::listen([
            'core.settings.slider.create.after',
            'core.settings.slider.update.after',
        ], 'Webphorium\ReinaBatata\Helpers\AdminHelper@storeSliderDetails');

        Event::listen('checkout.order.save.after', 'Webphorium\ReinaBatata\Helpers\Helper@topBrand');
    }
}
