...
@push('scripts')
    ...
    <script type="text/x-template" id="country-state-template">
        <div>
            <!-- <div class="control-group mb-3" :class="[errors.has('country') ? 'has-error' : '']">
                <label for="country" class="mandatory">
                    {{ __('shop::app.customer.account.address.create.country') }}
                </label>

                <select type="text" v-validate="'required'" class="form-control styled-select" id="country" name="country" v-model="country" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.country') }}&quot;">
                    <option value=""></option>
            ...
            <div class="control-group mb-3" :class="[errors.has('state') ? 'has-error' : '']">
