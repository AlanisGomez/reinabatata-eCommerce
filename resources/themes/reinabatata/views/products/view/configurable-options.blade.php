@if (Webkul\Product\Helpers\ProductType::hasVariants($product->type))
    ...
    @push('scripts')
        <script type="text/x-template" id="product-options-template">
            <div class="attributes d-flex d-md-block" v-if="childAttributes.length > 0">
                <input
                    type="hidden"
                ...
                <div
                    ...
                    <span
                        ...
                        <select
                            v-validate="'required'"
                            class="control form-control styled-select"
                    ...
                    <span class="control-error d-block" v-if="errors.has('super_attribute[' + attribute.id + ']')">
